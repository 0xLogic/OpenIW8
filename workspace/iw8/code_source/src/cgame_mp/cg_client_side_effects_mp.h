/*
==============
CgClientSideEffectsSystemMP::GetClientSideEffectsSystemMP
==============
*/

CgClientSideEffectsSystemMP *__fastcall CgClientSideEffectsSystemMP::GetClientSideEffectsSystemMP(const LocalClientNum_t localClientNum)
{
  return ?GetClientSideEffectsSystemMP@CgClientSideEffectsSystemMP@@SAPEAV1@W4LocalClientNum_t@@@Z(localClientNum);
}
...
==============
*/
CgClientSideEffectsSystem *CgClientSideEffectsSystemMP::GetClientSideEffectsSystemMP(const LocalClientNum_t localClientNum)
{
  __int64 v1; 
  __int64 v3; 
  __int64 v4; 
